...
public class IEliminarCita extends javax.swing.JFrame implements InterfazEliminar{

  
    public IEliminarCita() {
    ...
    private void initComponents() {
        ...
        btnEliminar.setActionCommand("Eliminar cita");

        btnVolver.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        btnVolver.setText("Volver");
        btnVolver.setActionCommand("Volver opciones cita desde eliminar");
