...
public class IModificarMedicamento extends javax.swing.JFrame implements InterfazModificar {

    public IModificarMedicamento() {
    ...
    private void initComponents() {
        ...
        btnGuardar.setActionCommand("Modificar med");

        btnVolver.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        btnVolver.setText("Volver");
        btnVolver.setActionCommand("Volver modificar inicio med desde modificar");
    ...
    public void escribir(Medicamentos med) {
        ...
        txtPrincipio.setText(med.getPrincipio());
        txtTipo.setText(med.getTipo());
        txtCantidad.setText(med.getStock().toString());
        txtGramaje.setText(med.getGramaje().toString());
    }
